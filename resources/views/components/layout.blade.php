  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">MyApp</a></h4>
    ...
    @if (session()->has('success'))
      <div class="container container--narrow">
        <div class="alert alert-success text-center">
          {{ session('success') }} <!-- session()->has('success')) is used to check if the 'success' key exists in the session. It allows you to conditionally handle or display certain logic or messages based on the presence or absence of the 'success' key in the session. -->
        </div>
      </div>
    @endif
    ...
    <div class="container container--narrow">
      <div class="alert alert-danger text-center">
        {{ session('failure') }} <!-- session()->has('failure')) is used to check if the 'success' key exists in the session. It allows you to conditionally handle or display certain logic or messages based on the presence or absence of the 'failure' key in the session. -->
      </div>
    </div>
  @endif
